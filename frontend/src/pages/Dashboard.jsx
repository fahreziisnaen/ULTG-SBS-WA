  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <div className="grid grid-cols-3 gap-3">
        <StatCard label="Total Instance" value={instances.length} color="text-gray-900" />
        <StatCard label="Terhubung" value={connectedCount} color="text-green-600" />
        <StatCard
          label="Offline"
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-sm font-semibold text-gray-700">Instances WhatsApp</h2>
          <Link
            to="/instances"
        ...
        {instances.length === 0 && (
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 text-center">
            ...
            <p className="text-sm text-gray-500">Belum ada instance.</p>
            <Link
              to="/instances"
              className="inline-block mt-2 text-sm font-medium text-wa-teal hover:underline"
            >
              Tambah instance WhatsApp pertama →
            </Link>
          </div>
        )}
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-xl px-5 py-4 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">Lihat dokumentasi untuk mempelajari cara menghubungkan aplikasi Anda.</p>
        </div>
