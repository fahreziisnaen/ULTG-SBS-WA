    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <img src="/logo-harpro.png" alt="PLN Proteksi ULTG SBS" className="w-16 h-16 object-contain mx-auto mb-3 rounded-sm" />
          <h1 className="text-2xl font-bold text-gray-900">WA Gateway</h1>
          <p className="text-sm text-gray-500 mt-1">PLN Proteksi ULTG SBS</p>
        </div>
            ...
            {step === 'credentials' ? (
              ...
              <>
                <div className="text-center mb-4">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Masukkan kode 6 digit dari aplikasi autentikator Anda.</p>
                </div>
