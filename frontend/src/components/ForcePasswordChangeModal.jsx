...
export default function ForcePasswordChangeModal() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setError(err.response?.data?.error ?? 'Gagal memperbarui kata sandi');
    } finally {
      setSaving(false);
    }
  }
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Mohon ubah kata sandi default Anda
            </p>
          </div>
        </div>

        <p className="text-sm text-gray-600 mb-5">
          Demi keamanan, Anda harus mengubah kata sandi sebelum mengakses dashboard.
        </p>
