...
const NAV = [
  ...
  { path: '/logs', label: 'Log', Icon: ScrollText },
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 py-5 border-b border-gray-100">
        <div className="flex items-center gap-3">
          <img src="/logo-harpro.png" alt="PLN Proteksi ULTG SBS" className="w-9 h-9 object-contain rounded-sm" />
          <div>
            <p className="font-bold text-gray-900 leading-tight text-sm">WA Gateway</p>
            <p className="text-[10px] text-gray-400 leading-tight">PLN Proteksi ULTG SBS</p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-gray-100 p-3 space-y-2">
        <div className="flex items-center gap-1.5 text-xs text-gray-400 px-1">
          ...
          <span>{socketConnected ? 'Pembaruan langsung aktif' : 'Menghubungkan ulang…'}</span>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <div className="md:hidden flex items-center justify-between px-4 py-3 bg-white border-b border-gray-200 shadow-sm">
          ...
          <div className="flex items-center gap-2">
            <img src="/logo-harpro.png" alt="PLN Proteksi ULTG SBS" className="w-6 h-6 object-contain rounded-sm" />
